...
There are several changes I made including the background colors I also changed the default text and added a timer that changes some text on the screen
