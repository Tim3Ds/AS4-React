...
There are several changes I made including the background colorc I also changed the default text and added a timer that changes some text on the screen
